...
/* Multimedia card connection with the Atmega */
#define MMC_PORT      PORTB			// MMC Connection port
#define MMC_DIR       DDRB			// MMC Direction port
#define MMC_CS        PB2			// MMC card chip select signal

#define CARD_PORT     PORTA			// Card detection/write protection Connection port
#define CARD_DIR      DDRA			// Card detection/write protection Direction port
#define CARD_INP      PINA			// Card detection/write protection Input port
#define CARD_DET      PA1			// Card detection pin
#define CARD_WP       PA0			// Card write protection pin
...
uint8_t mmc_command (uint8_t, uint32_t);
uint8_t mmc_sendcommand (uint8_t, uint32_t);
uint16_t mmc_read_sector (uint32_t, uint16_t, char *);
