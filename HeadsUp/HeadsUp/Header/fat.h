...
uint8_t fat_open (uint16_t, char *, char *, FAT_FILE *);
uint16_t fat_read (char *, uint16_t, FAT_FILE *);
void fat_seek (FAT_FILE *, int32_t, uint8_t);
uint16_t dir_list (char *, FAT_FILE *);
